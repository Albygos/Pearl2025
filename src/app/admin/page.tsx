...
import { Star, Users, ImageIcon, ArrowRight, Building, Megaphone } from 'lucide-react';
    ...
    <div className="p-4 sm:p-6 lg:p-8 bg-background min-h-full">
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2 max-w-7xl mx-auto">
        ...
        <Card className="shadow-sm hover:shadow-md transition-shadow">
         ...
         <Card className="shadow-sm hover:shadow-md transition-shadow">
          <CardHeader>
            <CardTitle>Scoreboard Announcements</CardTitle>
            <CardDescription>Present scores in a full-screen slideshow format.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
              <Link href="/admin/announcement">Go to Announcements <ArrowRight className="ml-2" /></Link>
            </Button>
          </CardContent>
        </Card>
      </div>
